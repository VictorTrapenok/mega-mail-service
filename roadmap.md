...
4. Доступ к клиентскому форку: базовый коммит, diff, изменённые миграции
   и индексы. Если форк уже добавил составной индекс на `queued_messages`,
   главная гипотеза о узком месте отпадает.
5. Код или postmortem предыдущего прототипа на Go, который достигал 5 млн.
